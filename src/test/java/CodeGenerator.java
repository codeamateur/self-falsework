...
import com.tianqian.self.common.mybatisPlugin.MybatisCommentGenerator;
...
public class CodeGenerator {
    ...
    private static final String AUTHOR = "zjx";//@author
    ...
    public static void genModelAndMapper(String tableName, String modelName) {
        ...
        commentConfig.setConfigurationType(MybatisCommentGenerator.class.getName());
